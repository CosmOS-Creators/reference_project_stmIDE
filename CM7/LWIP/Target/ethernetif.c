...
static struct pbuf * low_level_input(struct netif *netif)
{
  ...
  if (HAL_ETH_IsRxDataAvailable(&heth))
  {
    ...
    //SCB_InvalidateDCache_by_Addr((uint32_t *)RxBuff->buffer, framelength); PATCH, PATCHED -
	//MPU is set to disable caching of the section and invalidating cache can cause hardfault in that case
#endif
