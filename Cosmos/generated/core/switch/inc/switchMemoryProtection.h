...
********************************************************************************/
    ...
    #define switchMemoryProtection_init(codeMemoryHighAddress, codeMemoryLowAddress, stackMemoryHighAddress, stackMemoryLowAddress) \
	memoryProtection_init(codeMemoryHighAddress, codeMemoryLowAddress, stackMemoryHighAddress, stackMemoryLowAddress)
#else
    #define switchMemoryProtection_init(codeMemoryHighAddress, codeMemoryLowAddress, stackMemoryHighAddress, stackMemoryLowAddress)
#endif
/********************************************************************************
