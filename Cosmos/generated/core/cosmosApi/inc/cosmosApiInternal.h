...
#define cosmosApiInternal_osEvent_triggerEventDataPoolCopyInternal(data,dataPool,size) \
(void)sysCalls_bitWidthType_voidPtr_voidPtr_bitWidthType_ret_bitWidthType(\
    SYSCALL_OSEVENT_TRIGGEREVENTDATAPOOLCOPYINTERNAL\
    ,data\
    ,dataPool\
    ,size\
    )
...
#define cosmosApiInternal_channel_sendConfigureChannelInternal(channelCfg,userReplyDataPool,userReplyPoolSize) \
(void)sysCalls_bitWidthType_voidPtr_voidPtr_bitWidthType_ret_bitWidthType(\
    SYSCALL_CHANNEL_SENDCONFIGURECHANNELINTERNAL\
    ,channelCfg\
    ,userReplyDataPool\
    ,userReplyPoolSize\
    )
#define cosmosApiInternal_channel_dataPoolCopyInternal(data,dataPool,size) \
(void)sysCalls_bitWidthType_voidPtr_voidPtr_bitWidthType_ret_bitWidthType(\
    SYSCALL_CHANNEL_DATAPOOLCOPYINTERNAL\
    ,data\
    ,dataPool\
    ,size\
    )
#define cosmosApiInternal_channel_setChannelSendPoolPayloadLengthInternal(channelCfg,length) \
(void)sysCalls_bitWidthType_voidPtr_bitWidthType_ret_bitWidthType(\
    SYSCALL_CHANNEL_SETCHANNELSENDPOOLPAYLOADLENGTHINTERNAL\
    ,channelCfg\
    ,length\
    )
/********************************************************************************
