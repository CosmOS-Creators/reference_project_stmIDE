...
extern unsigned char _s_program_default_CM7_section_noInit[];
extern unsigned char _s_program_timing_measurement_CM7_section_init[];
extern unsigned char _s_program_timing_measurement_CM7_section_noInit[];
extern unsigned char _s_program_default_CM4_section_init[];
extern unsigned char _s_program_default_CM4_section_noInit[];
extern unsigned char _s_program_timing_measurement_CM4_section_init[];
extern unsigned char _s_program_timing_measurement_CM4_section_noInit[];
extern unsigned char _s_program_logger_section_init[];
extern unsigned char _s_program_logger_section_noInit[];
extern unsigned char _s_program_ethernet_com_section_init[];
extern unsigned char _s_program_ethernet_com_section_noInit[];
...
extern unsigned char _e_program_default_CM7_section_noInit[];
extern unsigned char _e_program_timing_measurement_CM7_section_init[];
extern unsigned char _e_program_timing_measurement_CM7_section_noInit[];
extern unsigned char _e_program_default_CM4_section_init[];
extern unsigned char _e_program_default_CM4_section_noInit[];
extern unsigned char _e_program_timing_measurement_CM4_section_init[];
extern unsigned char _e_program_timing_measurement_CM4_section_noInit[];
extern unsigned char _e_program_logger_section_init[];
extern unsigned char _e_program_logger_section_noInit[];
extern unsigned char _e_program_ethernet_com_section_init[];
extern unsigned char _e_program_ethernet_com_section_noInit[];
...
extern unsigned char _flash_program_timing_measurement_CM7_section_init[];
extern unsigned char _flash_program_default_CM4_section_init[];
extern unsigned char _flash_program_timing_measurement_CM4_section_init[];
extern unsigned char _flash_program_logger_section_init[];
extern unsigned char _flash_program_ethernet_com_section_init[];
extern unsigned char _flash_os_section_consts_start[];
extern unsigned char _flash_os_section_vars_start[];

const CosmOS_ProgramSectionConfigurationType clearSectionsCore0[CLEAR_SECTION_NUM_CORE_0]
IS_INITIALIZED_TO
{
		{
...
const CosmOS_ProgramSectionConfigurationType clearSectionsCore1[CLEAR_SECTION_NUM_CORE_1]
IS_INITIALIZED_TO
{
		{
...
const CosmOS_ProgramSectionConfigurationType bootSectionsCore0[BOOT_SECTION_NUM_CORE_0]
IS_INITIALIZED_TO
{
		{
...
const CosmOS_ProgramSectionConfigurationType bootSectionsCore1[BOOT_SECTION_NUM_CORE_1]
IS_INITIALIZED_TO
{
		{
