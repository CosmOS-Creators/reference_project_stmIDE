...
#define PROGRAM_1_CORE_0_LOW_ADDRESS    (AddressType)0x20001c00    /* Program blinking_led_CM7 memoryLowAddress */
#define PROGRAM_1_CORE_0_HIGH_ADDRESS    (AddressType)0x20002000    /* Program blinking_led_CM7 memoryHighAddress */
#define PROGRAM_1_CORE_0_HEAP_SIZE    (BitWidthType)256    /* Program blinking_led_CM7 heap size */
#define PROGRAM_1_CORE_0_HEAP_LOW_ADDRESS    (AddressType)0x20001f00    /* Program blinking_led_CM7 heapLowAddress */
#define PROGRAM_1_CORE_0_HEAP_HIGH_ADDRESS    (AddressType)0x20002000    /* Program blinking_led_CM7 heapHighAddress */
...
#define PROGRAM_2_CORE_0_ID     (BitWidthType)2    /* Program logger identificator */

#define PROGRAM_2_CORE_0_SIZE    (BitWidthType)1024    /* Program logger size */
#define PROGRAM_2_CORE_0_LOW_ADDRESS    (AddressType)0x20002000    /* Program logger memoryLowAddress */
#define PROGRAM_2_CORE_0_HIGH_ADDRESS    (AddressType)0x20002400    /* Program logger memoryHighAddress */
#define PROGRAM_2_CORE_0_HEAP_SIZE    (BitWidthType)256    /* Program logger heap size */
#define PROGRAM_2_CORE_0_HEAP_LOW_ADDRESS    (AddressType)0x20002300    /* Program logger heapLowAddress */
#define PROGRAM_2_CORE_0_HEAP_HIGH_ADDRESS    (AddressType)0x20002400    /* Program logger heapHighAddress */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @}
