...
#define SPINLOCK_2_ID                      (BitWidthType)2    /* Spinlock identifier for buffer 0 */
#define SPINLOCK_3_ID                      (BitWidthType)3    /* Spinlock identifier for second buffer of doubleBuffer 0 */
#define SPINLOCK_4_ID                      (BitWidthType)4    /* Spinlock identifier for buffer 2 */
#define SPINLOCK_5_ID                      (BitWidthType)5    /* Spinlock identifier for buffer 3 */
#define SPINLOCK_6_ID                      (BitWidthType)6    /* Spinlock identifier for core event */

#define SPINLOCK_NUM                                    (BitWidthType)7    /* Number of configured spinlocks */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @} */
