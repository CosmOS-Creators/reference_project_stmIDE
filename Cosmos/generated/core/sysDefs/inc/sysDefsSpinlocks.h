...
#define SPINLOCK_0_ID                      (BitWidthType)0    /* Spinlock identifier */
#define SPINLOCK_1_ID                      (BitWidthType)1    /* Spinlock identifier */
/* Buffer Spinlock identifiers */
#define SPINLOCK_2_ID                      (BitWidthType)2    /* Spinlock identifier */
#define SPINLOCK_3_ID                      (BitWidthType)3    /* Spinlock identifier */
#define SPINLOCK_4_ID                      (BitWidthType)4    /* Spinlock identifier */
#define SPINLOCK_5_ID                      (BitWidthType)5    /* Spinlock identifier */

#define SPINLOCK_NUM                                    (BitWidthType)6    /* Number of configured spinlocks */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @} */
