...
#define SPINLOCK_6_ID                      (BitWidthType)6    /* Spinlock identifier for operating system event */

#define SPINLOCK_NUM                                    (BitWidthType)7    /* Number of configured spinlocks */

#define SPINLOCK_NUM_PREPROCESSOR                                    7    /* Number of configured spinlocks without a specific type cast */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @} */
