...
/********************************************************************************
  ...
  * @{
********************************************************************************/
#define TASK_PROGRAM_0_CORE_0_NUM             (BitWidthType)2        /* Number of configured tasks for the program demo_program_CM7*/
#define TASK_PROGRAM_0_CORE_1_NUM             (BitWidthType)2        /* Number of configured tasks for the program demo_program_CM4*/

#define TASK_0_PROGRAM_0_CORE_0_ID            (BitWidthType)0        /* Task demo_task_togglePin_CM7 identifier */
#define TASK_0_PROGRAM_0_CORE_0_WCET          (BitWidthType)5        /* The Worst execution time in ticks */

#define TASK_0_PROGRAM_0_CORE_1_ID            (BitWidthType)0        /* Task demo_task_togglePin_CM4 identifier */
#define TASK_0_PROGRAM_0_CORE_1_WCET          (BitWidthType)5        /* The Worst execution time in ticks */

#define TASK_1_PROGRAM_0_CORE_0_ID            (BitWidthType)1        /* Task idle_CM7 identifier */
#define TASK_1_PROGRAM_0_CORE_0_WCET          (BitWidthType)0        /* The Worst execution time in ticks */

#define TASK_1_PROGRAM_0_CORE_1_ID            (BitWidthType)1        /* Task idle_CM4 identifier */
#define TASK_1_PROGRAM_0_CORE_1_WCET          (BitWidthType)0        /* The Worst execution time in ticks */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @} */
