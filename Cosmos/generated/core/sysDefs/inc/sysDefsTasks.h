...
#define TASK_PROGRAM_1_CORE_0_NUM             (BitWidthType)1        /* Number of configurated tasks for the program timing_measurement_CM7*/
#define TASK_PROGRAM_0_CORE_1_NUM             (BitWidthType)2        /* Number of configurated tasks for the program default_CM4*/
#define TASK_PROGRAM_1_CORE_1_NUM             (BitWidthType)1        /* Number of configurated tasks for the program timing_measurement_CM4*/
#define TASK_PROGRAM_2_CORE_1_NUM             (BitWidthType)0        /* Number of configurated tasks for the program logger*/
#define TASK_PROGRAM_2_CORE_0_NUM             (BitWidthType)0        /* Number of configurated tasks for the program ethernet_com*/
...
#define TASK_0_PROGRAM_1_CORE_0_ID            (BitWidthType)0        /* Task Timing_measurement_task_CM7 identificator */
...
#define TASK_0_PROGRAM_1_CORE_1_ID            (BitWidthType)0        /* Task Timing_measurement_task_CM4 identificator */
