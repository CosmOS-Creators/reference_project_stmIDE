...
/********************************************************************************
  ...
  * @{
********************************************************************************/
#define SCHEDULABLE_NUM                 (BitWidthType)10        /* Maximal number of configurated schedulables on one core  */

#define SCHEDULABLE_NUM_CORE_0                       (BitWidthType)5        /* Number of configurated schedulables for the core CM7 */
#define SCHEDULABLE_NUM_CORE_1                       (BitWidthType)5        /* Number of configurated schedulables for the core CM4 */
