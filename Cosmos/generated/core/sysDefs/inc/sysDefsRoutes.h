...
#define OSEVENT_TRIGGEREVENTDATAPOOLCOPYINTERNAL (BitWidthType)20            /* identifier pointing on function pointer in array (Routes) */
#define CHANNEL_SENDREPLYOBTAINEDINTERNAL (BitWidthType)21            /* identifier pointing on function pointer in array (Routes) */
#define CHANNEL_SENDCONFIGURECHANNELINTERNAL (BitWidthType)22            /* identifier pointing on function pointer in array (Routes) */
#define CHANNEL_DATAPOOLCOPYINTERNAL (BitWidthType)23            /* identifier pointing on function pointer in array (Routes) */
#define CHANNEL_SETCHANNELSENDPOOLPAYLOADLENGTHINTERNAL (BitWidthType)24            /* identifier pointing on function pointer in array (Routes) */
...
#define SYSCALL_OSEVENT_TRIGGEREVENTDATAPOOLCOPYINTERNAL (BitWidthType)20            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_CHANNEL_SENDREPLYOBTAINEDINTERNAL (BitWidthType)21            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_CHANNEL_SENDCONFIGURECHANNELINTERNAL (BitWidthType)22            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_CHANNEL_DATAPOOLCOPYINTERNAL (BitWidthType)23            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_CHANNEL_SETCHANNELSENDPOOLPAYLOADLENGTHINTERNAL (BitWidthType)24            /* identifier pointing on function pointer in array (Routes) */
