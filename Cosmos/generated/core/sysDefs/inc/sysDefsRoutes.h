...
#define SYSCALL_OS_WRITE32 (BitWidthType)9            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_OS_WRITE16 (BitWidthType)10            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_OS_WRITE8 (BitWidthType)11            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_GETMUTEXINTERNAL (BitWidthType)12            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_TRYMUTEXINTERNAL (BitWidthType)13            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_RELEASEMUTEXINTERNAL (BitWidthType)14            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_INTERRUPT_DISABLEINTERRUPT (BitWidthType)15            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_INTERRUPT_ENABLEINTERRUPT (BitWidthType)16            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_CILCORE_GETCOREID (BitWidthType)17            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_SPINLOCK_GETSPINLOCKINTERNAL (BitWidthType)18            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_SPINLOCK_TRYSPINLOCKINTERNAL (BitWidthType)19            /* identifier pointing on function pointer in array (Routes) */
#define SYSCALL_SPINLOCK_RELEASESPINLOCKINTERNAL (BitWidthType)20            /* identifier pointing on function pointer in array (Routes) */

#define ROUTES_ID_TO_FUNC_NUM (BitWidthType)21    /* Number of route identifiers */
#define ROUTES_ID_TO_ENTITY_NUM (BitWidthType)21     /* Number of route identifiers */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @} */
