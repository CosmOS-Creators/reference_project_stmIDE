...
/********************************************************************************
  ...
  * @{
********************************************************************************/
#define ROUTES_FUNC_NUM (BitWidthType)29          /* Number of route RW */
...
#define INTERRUPT_HANDLEINTERNAL (BitWidthType)28            /* identifier pointing on function pointer in array (Routes) */
...
#define SYSCALL_INTERRUPT_HANDLEINTERNAL (BitWidthType)28            /* identifier pointing on function pointer in array (Routes) */
