...
#define THREAD_SLEEPMSINTERNAL (BitWidthType)12            /* Identificator pointing on function pointer in array (Routes) */
#define OS_WRITE32 (BitWidthType)13            /* Identificator pointing on function pointer in array (Routes) */
#define OS_WRITE16 (BitWidthType)14            /* Identificator pointing on function pointer in array (Routes) */
#define OS_WRITE8 (BitWidthType)15            /* Identificator pointing on function pointer in array (Routes) */
#define MUTEX_GETMUTEXINTERNAL (BitWidthType)16            /* Identificator pointing on function pointer in array (Routes) */
#define MUTEX_TRYMUTEXINTERNAL (BitWidthType)17            /* Identificator pointing on function pointer in array (Routes) */
#define MUTEX_RELEASEMUTEXINTERNAL (BitWidthType)18            /* Identificator pointing on function pointer in array (Routes) */
#define INTERRUPT_DISABLEINTERRUPT (BitWidthType)19            /* Identificator pointing on function pointer in array (Routes) */
#define INTERRUPT_ENABLEINTERRUPT (BitWidthType)20            /* Identificator pointing on function pointer in array (Routes) */
#define CILCORE_GETCOREID (BitWidthType)21            /* Identificator pointing on function pointer in array (Routes) */
...
#define SYSCALL_READ_BUFFER_3_ID (BitWidthType)12   /* Identificator pointing on element in id array (RoutesIdToFuncConst) */
#define SYSCALL_WRITE_BUFFER_3_ID (BitWidthType)13  /* Identificator pointing on element in id array (RoutesIdToFuncConst) */
#define SYSCALL_DEVICEIO_TOGGLEPIN (BitWidthType)14            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OSINIT_INIT (BitWidthType)15            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OS_START (BitWidthType)16            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_SCHEDULABLE_SETEXECUTIONSTATETOFINISHED (BitWidthType)17            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_SYSJOBS_DISPATCHER (BitWidthType)18            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_INTERRUPT_DISABLEINTERRUPTS (BitWidthType)19            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_INTERRUPT_ENABLEINTERRUPTS (BitWidthType)20            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_THREAD_SLEEPMSINTERNAL (BitWidthType)21            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OS_WRITE32 (BitWidthType)22            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OS_WRITE16 (BitWidthType)23            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OS_WRITE8 (BitWidthType)24            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_GETMUTEXINTERNAL (BitWidthType)25            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_TRYMUTEXINTERNAL (BitWidthType)26            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_RELEASEMUTEXINTERNAL (BitWidthType)27            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_INTERRUPT_DISABLEINTERRUPT (BitWidthType)28            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_INTERRUPT_ENABLEINTERRUPT (BitWidthType)29            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_CILCORE_GETCOREID (BitWidthType)30            /* Identificator pointing on function pointer in array (Routes) */

#define ROUTES_ID_TO_FUNC_NUM (BitWidthType)31    /* Number of route identificators */
#define ROUTES_ID_TO_ENTITY_NUM (BitWidthType)31     /* Number of route identificators */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @}
