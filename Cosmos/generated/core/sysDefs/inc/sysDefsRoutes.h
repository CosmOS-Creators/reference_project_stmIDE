...
/********************************************************************************
  ...
  * @{
********************************************************************************/
#define ROUTES_FUNC_NUM (BitWidthType)10          /* Number of route RW */
...
#define ROUTES_ID_TO_FUNC_NUM (BitWidthType)17    /* Number of route identificators */
#define ROUTES_ID_TO_ENTITY_NUM (BitWidthType)17     /* Number of route identificators */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @}
