...
#define THREAD_SLEEPMS (BitWidthType)12            /* Identificator pointing on function pointer in array (Routes) */
...
#define MUTEX_GETMUTEXPRIVILEGED (BitWidthType)16            /* Identificator pointing on function pointer in array (Routes) */
#define MUTEX_TRYMUTEXPRIVILEGED (BitWidthType)17            /* Identificator pointing on function pointer in array (Routes) */
#define MUTEX_RELEASEMUTEXPRIVILEGED (BitWidthType)18            /* Identificator pointing on function pointer in array (Routes) */
...
#define SYSCALL_THREAD_SLEEPMS (BitWidthType)19            /* Identificator pointing on function pointer in array (Routes) */
...
#define SYSCALL_MUTEX_GETMUTEXPRIVILEGED (BitWidthType)23            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_TRYMUTEXPRIVILEGED (BitWidthType)24            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_RELEASEMUTEXPRIVILEGED (BitWidthType)25            /* Identificator pointing on function pointer in array (Routes) */
