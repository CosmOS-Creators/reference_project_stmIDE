...
#define SYSCALL_READ_BUFFER_2_ID (BitWidthType)4   /* Identificator pointing on element in id array (RoutesIdToFuncConst) */
#define SYSCALL_WRITE_BUFFER_2_ID (BitWidthType)5  /* Identificator pointing on element in id array (RoutesIdToFuncConst) */
#define SYSCALL_DEVICEIO_TOGGLEPIN (BitWidthType)6            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OSINIT_INIT (BitWidthType)7            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OS_START (BitWidthType)8            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_SCHEDULABLE_SETEXECUTIONSTATETOFINISHED (BitWidthType)9            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_SYSJOBS_DISPATCHER (BitWidthType)10            /* Identificator pointing on function pointer in array (Routes) */

#define ROUTES_ID_TO_FUNC_NUM (BitWidthType)11    /* Number of route identificators */
#define ROUTES_ID_TO_ENTITY_NUM (BitWidthType)11     /* Number of route identificators */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @}
