...
/********************************************************************************
  ...
  * @{
********************************************************************************/
#define ROUTES_FUNC_NUM (BitWidthType)19          /* Number of route RW */
...
#define SYSCALL_THREAD_SLEEPMSINTERNAL (BitWidthType)19            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OS_WRITE32 (BitWidthType)20            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OS_WRITE16 (BitWidthType)21            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_OS_WRITE8 (BitWidthType)22            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_GETMUTEXINTERNAL (BitWidthType)23            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_TRYMUTEXINTERNAL (BitWidthType)24            /* Identificator pointing on function pointer in array (Routes) */
#define SYSCALL_MUTEX_RELEASEMUTEXINTERNAL (BitWidthType)25            /* Identificator pointing on function pointer in array (Routes) */

#define ROUTES_ID_TO_FUNC_NUM (BitWidthType)26    /* Number of route identificators */
#define ROUTES_ID_TO_ENTITY_NUM (BitWidthType)26     /* Number of route identificators */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @}
