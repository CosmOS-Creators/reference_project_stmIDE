...
/********************************************************************************
  ...
  * @{
********************************************************************************/
#define EVENTS_FUNC_NUM (BitWidthType)4          /* Number of event handler */
...
#define OS_EVENT_CHANNEL_SIGNALIZEREPLY (BitWidthType)1            /* identifier pointing on function channel_signalizeReply in event handler function array */
#define OS_EVENT_CHANNEL_SIGNALIZESEND (BitWidthType)2            /* identifier pointing on function channel_signalizeSend in event handler function array */
#define OS_EVENT_INTERRUPT_SIGNALIZETHREAD (BitWidthType)3            /* identifier pointing on function interrupt_signalizeThread in event handler function array */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @} */
