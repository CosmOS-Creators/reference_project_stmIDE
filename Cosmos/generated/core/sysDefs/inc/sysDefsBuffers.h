...
/********************************************************************************
  ...
  * @{
********************************************************************************/
#define BUFFER_NUM (BitWidthType)4     /* Number of initialized buffers */


#define BUFFER_0_ID      (BitWidthType)0      /* Buffer x_core_buffer_0 id */
#define BUFFER_0_SIZE (BitWidthType)32      /* Buffer x_core_buffer_0 size in bytes */

#define BUFFER_1_ID      (BitWidthType)1      /* Buffer x_core_buffer_0 id */
#define BUFFER_1_SIZE (BitWidthType)32      /* Buffer x_core_buffer_0 size in bytes */

#define BUFFER_2_ID      (BitWidthType)2      /* Buffer x_core_buffer_1 id */
#define BUFFER_2_SIZE (BitWidthType)32      /* Buffer x_core_buffer_1 size in bytes */

#define BUFFER_3_ID      (BitWidthType)3      /* Buffer logger_buffer id */
#define BUFFER_3_SIZE (BitWidthType)2048      /* Buffer logger_buffer size in bytes */
/********************************************************************************
  * DOXYGEN STOP GROUP                                                         **
  * *************************************************************************//**
  * @} */
