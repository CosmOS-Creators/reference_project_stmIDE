...
IS_INITIALIZED_TO{
    ...
    {
        &ThreadsProgram0Core0Var[THREAD_1_PROGRAM_0_CORE_0_ID],    /* const CosmOS_ThreadVariableType * const var */
        &ThreadsSchedulablesCfgConst[SCHEDULABLE_THREAD_1_PROGRAM_0_CORE_0_ID],    /* const CosmOS_SchedulableConfigurationType * const schedulable */
        THREAD_1_PROGRAM_0_CORE_0_PRIORITY,    /* const BitWidthType priority */
    },
};
const CosmOS_ThreadConfigurationType
...
IS_INITIALIZED_TO{
    ...
    {
        &ThreadsProgram0Core1Var[THREAD_1_PROGRAM_0_CORE_1_ID],    /* const CosmOS_ThreadVariableType * const var */
        &ThreadsSchedulablesCfgConst[SCHEDULABLE_THREAD_1_PROGRAM_0_CORE_1_ID],    /* const CosmOS_SchedulableConfigurationType * const schedulable */
        THREAD_1_PROGRAM_0_CORE_1_PRIORITY,    /* const BitWidthType priority */
    },
};
/* @cond S */
